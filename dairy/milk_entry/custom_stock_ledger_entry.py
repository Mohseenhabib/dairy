...
# ----------------------------------------------------------------------------------------------------------------------------
        ...
        if self.voucher_type == "Purchase Invoice":
            ...
            doc = frappe.get_doc("Purchase Invoice", {"name":self.voucher_no, "set_warehouse": self.warehouse})
...
# -------------------------------------------------------------------------------------------------------------------------------
        ...
        if self.voucher_type == "Stock Reconciliation":
            ...
            doc = frappe.get_doc("Stock Reconciliation", {"name":self.voucher_no, "set_warehouse": self.warehouse})
