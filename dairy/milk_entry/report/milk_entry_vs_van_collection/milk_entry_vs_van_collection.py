...
def get_columns(filters, trans):
	...
	columns = based_on_details["based_on_cols"] + period_cols + \
			[_("Total(Cow Milk Entry)") + ":Float:120",
			 ...
			 _("Total(Buffalow Milk Entry)") + ":Float:120",
			 _("Total(Buffalow Milk Collected)") + ":Float:120",
			 _("Total(Buffalow Milk Cans)") + ":Float:120",
...
def period_wise_columns_query(filters, trans):
	...
	if filters.get("period") != 'Yearly':
		...
		pwc = [_(filters.get("fiscal_year")) + " ("+ _("Cow Milk Entry") + "):Float:120",
			...
			_(filters.get("fiscal_year")) + " ("+ _("Buffalow Milk Entry") + "):Float:120",
			_(filters.get("fiscal_year")) + " ("+ _("Buffalow Milk Collected") + "):Float:120",
			_(filters.get("fiscal_year")) + " ("+ _("Buffalow Milk Cans") + "):Float:120",
...
def get_period_wise_columns(bet_dates, period, pwc):
	if period == 'Monthly':
		pwc += [_(get_mon(bet_dates[0])) + " ("+ _("Cow Milk Entry") + "):Float:120",
				...
				_(get_mon(bet_dates[0])) + " ("+ _("Buffalow Milk Entry") + "):Float:120",
				_(get_mon(bet_dates[0])) + " ("+ _("Buffalow Milk Collected") + "):Float:120",
				_(get_mon(bet_dates[0])) + " ("+ _("Buffalow Milk Cans") + "):Float:120",
