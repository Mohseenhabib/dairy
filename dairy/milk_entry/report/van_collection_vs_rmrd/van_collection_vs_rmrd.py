...
def get_columns(filters, trans):
	...
	columns = based_on_details["based_on_cols"] + period_cols + \
			[_("Total(Good Cow Milk)") + ":Float:120",
				...
				_("Total(Good Buffalow Milk)") + ":Float:120",
				_("Total(Good buffalow Milk Cans)") + ":Float:120",
				...
				_("Total(Sour Buffalow Milk)") + ":Float:120",
				_("Total(Sour buffalow Milk Cans)") + ":Float:120",
				...
				_("Total(Curd Buffalow Milk)") + ":Float:120",
				_("Total(Curd buffalow Milk Cans)") + ":Float:120",
				...
				_("Total(Buffalow Milk FAT)") + ":Float:120",
				_("Total(Buffalow Milk CLR)") + ":Float:120",
...
def period_wise_columns_query(filters, trans):
	...
	if filters.get("period") != 'Yearly':
		...
		pwc =[  _(filters.get("fiscal_year")) + " ("+ _("Good Cow Milk") + "):Float:120",
				...
				_(filters.get("fiscal_year")) + " ("+ _("Good Buffalow Milk") + "):Float:120",
				_(filters.get("fiscal_year")) + " ("+ _("Good Buffalow Milk Can") + "):Float:120",
				...
				_(filters.get("fiscal_year")) + " ("+ _("Sour Buffalow Milk") + "):Float:120",
				_(filters.get("fiscal_year")) + " ("+ _("Sour Buffalow Milk Can") + "):Float:120",
				...
				_(filters.get("fiscal_year")) + " ("+ _("Curd Buffalow Milk") + "):Float:120",
				_(filters.get("fiscal_year")) + " ("+ _("Curd Buffalow Milk Can") + "):Float:120",
				...
				_(filters.get("fiscal_year")) + " ("+ _("Buffalow Milk FAT") + "):Float:120",
				_(filters.get("fiscal_year")) + " ("+ _("Buffalow Milk CLR") + "):Float:120",
...
def get_period_wise_columns(bet_dates, period, pwc):
	if period == 'Monthly':
		pwc += [_(get_mon(bet_dates[0])) + " (" + _("Good Cow Milk") + "):Float:120",
				...
				_(get_mon(bet_dates[0])) + " (" + _("Good Buffalow Milk") + "):Float:120",
				_(get_mon(bet_dates[0])) + " (" + _("Good Buffalow Milk Can") + "):Float:120",
				...
				_(get_mon(bet_dates[0])) + " (" + _("Sour Buffalow Milk") + "):Float:120",
				_(get_mon(bet_dates[0])) + " (" + _("Sour Buffalow Milk Can") + "):Float:120",
				...
				_(get_mon(bet_dates[0])) + " (" + _("Curd Buffalow Milk") + "):Float:120",
				_(get_mon(bet_dates[0])) + " (" + _("Curd Buffalow Milk Can") + "):Float:120",
				...
				_(get_mon(bet_dates[0])) + " (" + _("Buffalow Milk FAT") + "):Float:120",
				_(get_mon(bet_dates[0])) + " (" + _("Buffalow Milk CLR") + "):Float:120",
