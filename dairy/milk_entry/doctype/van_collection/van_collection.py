        ...
        if self:
            ...
            for res in warehouse:
                ...
                if cow_volume > 0 or buffalo_volume > 0 or mix_volume > 0:
                    ...
                    if flt(cow_volume) > 0:
                        van_collection.cow_milk_fat = flt(cow_milk_fatin_kg /(flt(cow_volume) * flt(item))) * 100 
                        van_collection.cow_milk_clr = flt(cow_milk_clrin_kg /(flt(cow_volume) * flt(item))) * 100 
                        van_collection.cow_milk_snf = flt(cow_milk_snfin_kg /(flt(cow_volume) * flt(item))) * 100
